""" Implements Ordinal Regression Loss
Taken from https://github.com/ck37/coral-ordinal/blob/master/coral_ordinal/loss.py
It is a Tensorflow implementation of the "Rank consistent ordinal regression for neural networks with application to age estimation" (2020) paper
